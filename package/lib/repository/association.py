...
class Association(object):
  ...
  def has_many(cls, callee, assoc_table, **kwargs):
    ...
    if "through" in kwargs:
      ...
      foreign_class = inflection.camelize(inflection.singularize(assoc_table)) if "foreign_class" not in kwargs else kwargs["foreign_class"]
  ...
  def belongs_to(cls, callee, assoc_table, **kwargs):
    ...
    cls.__associations[callee] = {}
    primary_class = inflection.camelize(assoc_table)
